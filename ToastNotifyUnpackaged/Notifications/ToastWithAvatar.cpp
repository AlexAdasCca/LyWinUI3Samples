...
bool ToastWithAvatar::SendToast()
{
    auto appNotification{ winrt::AppNotificationBuilder()
        ...
        .SetAppLogoOverride(winrt::Windows::Foundation::Uri(L"file://" + winrt::App::GetFullPathToAsset(L"AlexAlva.jpg")), winrt::AppNotificationImageCrop::Circle)
...
{
    winrt::ToastNotifyUnpackaged::Pages::Notification notification{};
    notification.Originator = ScenarioName;
    notification.Action = notificationActivatedEventArgs.Arguments().Lookup(L"action");
    winrt::ToastNotifyUnpackaged::Pages::MainPage::Current().NotificationReceived(notification);
